...
const NAV_ICONS = {
  ...
  vendorMaster: (
    <path
      d="M20 7H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9
          2-2V9c0-1.1-.9-2-2-2zm0 12H4V9h16v10zM12 3H4c-1.1 0-2 .9-2 2v2h2V5
          h8V3z"
    />
  ),
  ...
  banking: (
    <path
      d="M11.5 2C6.81 2 3 5.81 3 10.5S6.81 19 11.5 19h.5v3c4.86-2.34
          8-7 8-11.5C20 5.81 16.19 2 11.5 2zm1 14.5h-2v-2h2v2zm0-4h-2
          c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4
          1.79 4 4c0 2.5-3 2.75-3 5z"
    />
  ),

  taxCompliance: (
    <path
      d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9
  ...
  geographic: (
    <path
      d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87
  ...
  return (
    <aside style={styles.sidebar}>
      <div style={styles.logoWrap}>
        ...
        <div>
          <div style={styles.logoText}>Vendor Analytics</div>
          <div style={styles.logoSub}>Vendor Master Dashboard</div>
        </div>
      </div>
