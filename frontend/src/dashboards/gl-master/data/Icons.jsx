...
export const withBankAccount = (props) => (
  <SvgIcon {...props}>
...
export const MaturityCalIcon = (props) => (
  <SvgIcon {...props}>
...
export const ThreeLinesIcon = (props) => (
  <SvgIcon {...props}>
...
export const rectangularPanelIcon = (props) => (
  <SvgIcon {...props}>
...
export const dashboardPanelIcon = (props) => (
  <SvgIcon {...props}>
...
export const tdsAnalyticsIcon = (props) => (
  <SvgIcon {...props}>
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" />
  </SvgIcon>
);

export const locationMapIcon = (props) => (
  <SvgIcon {...props}>
...
export const ICONS = {
  ...
  storage: StorageIcon,
  clock: CLockIcon,
  maturity: MaturityCalIcon,
  alert: AlertIcon,
  threeLines: ThreeLinesIcon,
  globe: GlobeIcon,
  paper: paperIcon,
  lock: lockIcon,
  ...
  rectangularPanelIcon : rectangularPanelIcon,
  duplicateIcon : duplicateIcon,
  chatBubbleIcon : chatBubbleIcon,
  dashboardPanelIcon : dashboardPanelIcon,
  tdsAnalyticsIcon : tdsAnalyticsIcon,
  tickmarkIcon : tickmarkIcon,
  locationMapIcon : locationMapIcon,
  citiesIcon : citiesIcon,
